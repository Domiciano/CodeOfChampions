...
import { ActivityPodium, ActivityState, ClassType, SelectClassType, TopicDataType } from '../types/classes';
...
export const updateClassTopics = (db: Firestore, teacherId: string,  classProfiles: string[], classId: string, updatedTopics: TopicDataType[], callback: Function) => { 
  return async (dispatch: Dispatch<AnyAction>) => {
